...
const Price: React.FC<PriceProps> = ({
  ...
  return (
    <div>
      ...
      >
        <span className='ml-5 text-2xl font-extrabold'>Price</span>
        <img
          className='object-cover h-64'
          src='https://cdn.pixabay.com/photo/2013/02/06/19/37/cash-register-78741_1280.jpg'
          alt='Intro-Section'
        />
      </div>
      <CustomModal isOpen={isPriceModalOpen} closeModal={closePriceModal}>
        <Box sx={{ border: 'none' }}>
          <div className='flex flex-col mt-5 pb-4'>
            <span className='text-2xl w-11/12 mx-auto px-2 pb-3 font-medium text-purple-500'>
              서비스 요청을 반영하여 제작하는
            </span>
            <span className='text-5xl w-11/12 mx-auto px-2 pb-3 font-bold text-purple-500'>
              디자인형 홈페이지
            </span>
          </div>
            ...
            <table className='table-auto w-11/12 mx-auto px-2'>
              <thead>
                <tr className='bg-gray-700 text-white'>
                  <th className='border border-gray-400 px-2 py-2 '>구분</th>
              ...
              <tbody>
                ...
                <tr className='text-center'>
                  ...
                  <td className='border border-gray-400 px-2 py-2'>무제한</td>
                </tr>
                <tr className='text-center'>
                  <td className='border border-gray-400 px-2 py-2 font-bold'>
                    영상
            ...
            <table className='table-auto w-11/12 mx-auto px-2'>
              <tbody>
                  ...
                  <td className='border border-gray-400 px-2 py-2'>
                    <ul className='list-disc pl-4'>
                      ...
                      <li style={{ listStyleType: 'none' }}>
                        ...
                        파워포인트 문서 작성처럼 사용자가 직접 수정관리를 할 수
                        있음
                      </li>
                    </ul>
                  </td>
                ...
                <tr>
                  ...
                  <td className='border border-gray-400 px-2 py-2'>
                    <ul className='list-disc pl-4'>
                      <li>제작완료 후 관리자모드 사용법 교육(원격지원포함)</li>
          ...
          <div className='my-5 grid justify-items-center'>
            ...
            <table className='table-auto w-11/12 mx-auto px-2'>
              <thead>
                <tr className='bg-gray-700 text-white'>
                  <th className='border border-gray-400 px-2 py-2 '>종류</th>
                  <th className='border border-gray-400 px-2 py-2'>
                    등록비용(1년)
                  </th>
                  <th className='border border-gray-400 px-2 py-2 '>설명</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td className='border border-gray-400 px-2 py-2'>23,500원</td>
                  <td className='border border-gray-400 px-2 py-2'>
                ...
                <tr>
                  ...
                  <td className='border border-gray-400 px-2 py-2'>23,000원</td>
                  <td className='border border-gray-400 px-2 py-2'>
                ...
                <tr>
                  ...
                  <td className='border border-gray-400 px-2 py-2'>22,000원</td>
                  <td className='border border-gray-400 px-2 py-2'>
                ...
                <tr>
                  ...
                  <td className='border border-gray-400 px-2 py-2'>23,600원</td>
                  <td className='border border-gray-400 px-2 py-2'>
                    information의 약자로, 정보제공을 목적으로 하는 사이트에 주로
                    사용됩니다.
                  </td>
                </tr>
                <tr>
                  ...
                  <td className='border border-gray-400 px-2 py-2'>28,600원</td>
                  <td className='border border-gray-400 px-2 py-2'>
                ...
                <tr>
                  ...
                  <td className='border border-gray-400 px-2 py-2'>55,000원</td>
                  <td className='border border-gray-400 px-2 py-2'>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className='border border-none px-2 py-2'>
                    ...
                    <span className='block'>
                      (주문제작형 홈페이지 수정은 수정 분량과 범위에 따라 별도
                      견적)
                    </span>
                  </td>
                </tr>
