  ...
  return (
    <>
      ...
      <NewsSubIntroLayout>
        ...
        <NewsRightContentWrapper ref={rightRef}>
          <Outlet />
        </NewsRightContentWrapper>
      </NewsSubIntroLayout>
    </>
  );
}
...
const NewsSubIntroLayout = styled.div`
  display: flex;
...
const NewsSubLeftNavWrapper = styled.div`
...
const NewsRightContentWrapper = styled.div`
  flex: 1;
  position: sticky;
