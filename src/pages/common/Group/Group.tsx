...
function Group() {
  ...
  return (
    <>
      <SubPageBanner
        subPageBannerTitle={'믿음의 반석이 되는 공동체'}
        imageKey="Pastor"
      />
      <GroupSubIntroLayout>
        <GroupSubLeftNavWrapper
          ref={leftRef}
        ...
        <GroupRightContentWrapper ref={rightRef}>
          <Outlet />
        </GroupRightContentWrapper>
      </GroupSubIntroLayout>
    </>
  );
}
...
const GroupSubIntroLayout = styled.div`
  display: flex;
...
const GroupSubLeftNavWrapper = styled.div`
...
const GroupRightContentWrapper = styled.div`
  flex: 1;
  position: sticky;
