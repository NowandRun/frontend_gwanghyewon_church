  ...
  return (
    <>
      <SubPageBanner
        ...
        imageKey="Pastor"
      />
      <BroadcastSubIntroLayout>
        <BroadcastSubLeftNavWrapper
          ref={leftRef}
        ...
        <BroadcastRightContentWrapper ref={rightRef}>
          <Outlet />
        </BroadcastRightContentWrapper>
      </BroadcastSubIntroLayout>
    </>
  );
}
...
const BroadcastSubIntroLayout = styled.div`
  display: flex;
...
const BroadcastSubLeftNavWrapper = styled.div`
...
const BroadcastRightContentWrapper = styled.div`
  flex: 1;
  position: sticky;
