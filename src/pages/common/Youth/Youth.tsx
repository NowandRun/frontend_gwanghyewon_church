  ...
  return (
    <>
      ...
      <YouthSubIntroLayout>
        ...
        <YouthRightContentWrapper ref={rightRef}>
          <Outlet />
        </YouthRightContentWrapper>
      </YouthSubIntroLayout>
    </>
  );
}
...
const YouthSubIntroLayout = styled.div`
  display: flex;
...
const YouthSubLeftNavWrapper = styled.div`
...
const YouthRightContentWrapper = styled.div`
  flex: 1;
  position: sticky;
